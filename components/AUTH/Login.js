...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (formData.usernameOrEmail || formData.password) {
            ...
            await handleLogin(formData, setIsSigningIn);
        } else {
    ...
    return (
        <div
            ...
            className="w-screen h-screen main-bg flex items-center justify-center overflow-hidden bg-gray-800">
            <div className="flex flex-col items-center text-center mdl:px-44 w-full z-50">
                ...
                <h1 className="mb-1 mt-4 white-text font-bold text-center text-2xl mdl:text-[35px]">Welcome Back</h1>

                <p className="mb-1 main-text text-lg mdl:text-[18px] text-center text-white">Login and see what you missed.</p>
                ...
                <div className="w-full pl-3 pr-3 mdl:pl-0 mdl:pr-0">
                    ...
                    <button className="w-full py-3  rounded-lg bg-[#484852e0] flex justify-center items-center text-center space-x-3 my-1 hover:bg-[#ffffff25] ">
                        ...
                        <h2 className="white-text text-lg">Sign in by Phone</h2>
                    </button>
                    <button className="w-full py-3 rounded-lg bg-[#484852e0] flex justify-center items-center text-center space-x-3 my-1 hover:bg-[#ffffff25]">
                        ...
                        <h2 className="white-text text-lg">Sign up with Metamask</h2>
                    </button>
                </div>
                ...
                <div className="w-full h-full">
                    <motion.div
                        ...
                        <div className="flex flex-col text-left my-1 w-full px-3 mdl:px-0">
                            <label className="white-text text-base mdl:text-lg  w-full">Email Or Bragname</label>
                            <input
                                id="email"
                                ...
                                placeholder="Your email or bragname"
                            />
                        </div>
                        <div className="flex flex-col text-left my-1 w-full px-3 mdl:px-0 relative">
                            ...
                            <div className="flex items-center text-left space-x-3 w-full my-2 px-3 mdl:px-0">
                                <input
                                    ...
                                    className="w-4 h-4"
                                />
                                <p className="main-text text-base text-white">Remember me</p>
                            </div>

                            <button
                                onClick={handleSubmit}
                                className="btn-purp py-4 white-text rounded-lg my-1 border border-[#ccc] hover:brightness-125 px-3 mdl:px-0">
                                {isSigningIn ? "Processing..." : "Login"}
                            </button>
                        </div>
                    </motion.div>
                    <Link
